...
//     // Fetch product data only when categories are available and productId exists
//     useEffect(() => {
...
//             // Set default categories for new products
//             if (!productId || product.productCategoriesList.length === 0) {
...
//         if (formattedCategories.length === 0 && mandatoryCategories.length > 0) {
...
//                         const heirarchyLabel = hierarchy.length > 1 ? hierarchy.join('/') : details.name;
//                         result.push({
//                             key,
//                             value: details,
//                             heirarchyLabel,
...
//                 }
//                 console.log(restoredCats, 'restoredCats');
...
//                     imageFile: productData.image ? { uri: `${backendUrl}${productData.image.replace("/api", "")}` } : null,
...
const ProductEdit = ({ route }) => {
    ...
    const handleSubmit = async () => {
        ...
        let updatedProduct = {
            ...
            productCategories: mode === 'new' ? null : product.productCategories,
            metrics: {
                weight: product.gsm,
                width: product.width || ''
            },
